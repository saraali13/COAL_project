...
START_CLOCK:
    ...
    ; Update time display in place with color
...
; =======================
; Update Time Display with color
; =======================
...
; =======================
; Trigger Alarm with Sound and color
; =======================
TriggerAlarm PROC
    ; Play alarm sound
